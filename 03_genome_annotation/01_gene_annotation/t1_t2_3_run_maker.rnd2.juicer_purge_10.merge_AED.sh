...
echo -ne "Step 2: Merge gff files for split_rnd2 maker: "
date
...
/usr/bin/time --verbose gff3_merge -o S_flavescens.split_rnd2.all.gff scaffold_*/S_flavescens.scaffold_*.all.gff
AED_cdf_generator.pl -b 0.025 S_flavescens.split_rnd2.all.gff \
    >S_flavescens.split_rnd2.all.gff.AED_cdf.txt

cat scaffold_*/S_flavescens.scaffold_*.all.maker.transcripts.fasta \
    >S_flavescens.split_rnd2.all.maker.transcripts.fasta

cat scaffold_*/S_flavescens.scaffold_*.all.maker.proteins.fasta \
    >S_flavescens.split_rnd2.all.maker.proteins.fasta

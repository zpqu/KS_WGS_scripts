...
echo -ne "Step 2: Merge gff files for split_rnd3 maker: "
date
...
/usr/bin/time --verbose gff3_merge -o S_flavescens.split_rnd3.all.gff scaffold_*/S_flavescens.scaffold_*.all.gff
AED_cdf_generator.pl -b 0.025 S_flavescens.split_rnd3.all.gff \
    >S_flavescens.split_rnd3.all.gff.AED_cdf.txt

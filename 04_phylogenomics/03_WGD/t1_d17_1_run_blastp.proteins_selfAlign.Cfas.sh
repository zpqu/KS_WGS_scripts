...
genomeDIR="${wkDIR}/results/e1_canu_ec/maker/juicer_purge_10/DupGene_analysis/WGD_genomes/15_Chamaecrista_fasciculata"
outDIR="${wkDIR}/results/e1_canu_ec/maker/juicer_purge_10/DupGene_analysis/WGD_results/15_Chamaecrista_fasciculata"
dbDIR="${wkDIR}/DB"

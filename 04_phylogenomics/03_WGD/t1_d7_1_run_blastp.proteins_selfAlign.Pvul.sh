...
genomeDIR="${wkDIR}/results/e1_canu_ec/maker/juicer_purge_10/DupGene_analysis/WGD_genomes/05_Phaseolus_vulgaris"
outDIR="${wkDIR}/results/e1_canu_ec/maker/juicer_purge_10/DupGene_analysis/WGD_results/05_Phaseolus_vulgaris"
dbDIR="${wkDIR}/DB"

...
/usr/bin/time --verbose ${minimap2DIR}/minimap2 -t 32 \
    smartdenovo_raw_all.dmo.cns.fa \
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_1st.paf \
    smartdenovo_raw_all.dmo.cns.fa \
    > KS_nanopore.raw_all.smartdenovo.racon_1st.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_2nd.paf \
    KS_nanopore.raw_all.smartdenovo.racon_1st.fasta \
    > KS_nanopore.raw_all.smartdenovo.racon_2nd.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_3rd.paf \
    KS_nanopore.raw_all.smartdenovo.racon_2nd.fasta \
    > KS_nanopore.raw_all.smartdenovo.racon_3rd.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_4th.paf \
    KS_nanopore.raw_all.smartdenovo.racon_3rd.fasta \
    > KS_nanopore.raw_all.smartdenovo.racon_4th.fasta

...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_1st.paf \
    KS_raw_N50_wtdbg2.raw.fa \
    > KS_nanopore.raw_N50.wtdbg2.racon_1st.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_2nd.paf \
    KS_nanopore.raw_N50.wtdbg2.racon_1st.fasta \
    > KS_nanopore.raw_N50.wtdbg2.racon_2nd.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_3rd.paf \
    KS_nanopore.raw_N50.wtdbg2.racon_2nd.fasta \
    > KS_nanopore.raw_N50.wtdbg2.racon_3rd.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_4th.paf \
    KS_nanopore.raw_N50.wtdbg2.racon_3rd.fasta \
    > KS_nanopore.raw_N50.wtdbg2.racon_4th.fasta

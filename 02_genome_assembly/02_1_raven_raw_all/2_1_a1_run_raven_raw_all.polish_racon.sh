...
/usr/bin/time --verbose ${minimap2DIR}/minimap2 -t 32 \
    KS_nanopore.raw_all.raven.fasta \
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_1st.paf \
    KS_nanopore.raw_all.raven.fasta \
    > KS_nanopore.raw_all.raven.racon_1st.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_2nd.paf \
    KS_nanopore.raw_all.raven.racon_1st.fasta \
    > KS_nanopore.raw_all.raven.racon_2nd.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_3rd.paf \
    KS_nanopore.raw_all.raven.racon_2nd.fasta \
    > KS_nanopore.raw_all.raven.racon_3rd.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_4th.paf \
    KS_nanopore.raw_all.raven.racon_3rd.fasta \
    > KS_nanopore.raw_all.raven.racon_4th.fasta

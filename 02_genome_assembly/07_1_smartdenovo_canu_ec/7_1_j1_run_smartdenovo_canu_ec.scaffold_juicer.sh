...
hicDIR="/fast/genome/KS_WGS_20200626/HiC/results/2_trimmomatic"
outDIR="${wkDIR}/results/7_1_smartdenovo_canu_ec/juicer"
refDIR="${wkDIR}/results/7_1_smartdenovo_canu_ec/purge_haplotigs"

...
dataDIR="${wkDIR}/data"
outDIR="${wkDIR}/results/4_1_wtdbg2_raw_all"
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_1st.paf \
    KS_raw_all_wtdbg2.raw.fa \
    > KS_nanopore.raw_all.wtdbg2.racon_1st.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_2nd.paf \
    KS_nanopore.raw_all.wtdbg2.racon_1st.fasta \
    > KS_nanopore.raw_all.wtdbg2.racon_2nd.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_3rd.paf \
    KS_nanopore.raw_all.wtdbg2.racon_2nd.fasta \
    > KS_nanopore.raw_all.wtdbg2.racon_3rd.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_4th.paf \
    KS_nanopore.raw_all.wtdbg2.racon_3rd.fasta \
    > KS_nanopore.raw_all.wtdbg2.racon_4th.fasta

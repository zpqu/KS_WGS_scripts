...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_1st.paf \
    assembly.fasta \
    > KS_nanopore.fmlrc_N50.flye.racon_1st.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_2nd.paf \
    KS_nanopore.fmlrc_N50.flye.racon_1st.fasta \
    > KS_nanopore.fmlrc_N50.flye.racon_2nd.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_3rd.paf \
    KS_nanopore.fmlrc_N50.flye.racon_2nd.fasta \
    > KS_nanopore.fmlrc_N50.flye.racon_3rd.fasta
...
/usr/bin/time --verbose ${raconDIR}/racon \
    ...
    KS_nanopore.gfa_4th.paf \
    KS_nanopore.fmlrc_N50.flye.racon_3rd.fasta \
    > KS_nanopore.fmlrc_N50.flye.racon_4th.fasta

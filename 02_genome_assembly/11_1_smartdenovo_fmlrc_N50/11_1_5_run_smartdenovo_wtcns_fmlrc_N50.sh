...
#/usr/bin/time --verbose ${binDIR}/wtlay -i smartdenovo_fmlrc_N50.fa.gz \
#    -b smartdenovo_fmlrc_N50.dmo.obt \
#    -j smartdenovo_fmlrc_N50.dmo.ovl \
#    -fo smartdenovo_fmlrc_N50.dmo.lay \
#    -w 300 -s 200 -m 0.5 -r 0.95 -c 1

/usr/bin/time --verbose ${binDIR}/wtcns -t 32 \
    smartdenovo_fmlrc_N50.dmo.lay > smartdenovo_fmlrc_N50.dmo.cns.fa \
    2>smartdenovo_fmlrc_N50.dmo.cns.log

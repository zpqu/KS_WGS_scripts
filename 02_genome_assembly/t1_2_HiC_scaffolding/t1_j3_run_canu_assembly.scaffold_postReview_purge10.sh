...
outDIR="${wkDIR}/results/e1_canu_ec/juicer/purge_10/postReview"
...
/usr/bin/time --verbose ${binDIR}/run-asm-pipeline-post-review.sh \
    --sort-output \
    -r ../curated.rawchrom.review_ordered.assembly \
